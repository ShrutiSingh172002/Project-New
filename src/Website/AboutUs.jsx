...
import { FaYoutube, FaInstagram, FaFacebook, FaArrowLeft, FaCog, FaBolt, FaRecycle, FaCheckCircle, FaTarget, FaLeaf, FaWrench } from "react-icons/fa";
          ...
          <div className="mission-content">
            <div className="mission-points">
              <div className="mission-point">
                <div className="mission-icon"><FaTarget /></div>
                <span>Deliver high-quality components with fast turnaround</span>
              </div>
              <div className="mission-point">
                <div className="mission-icon"><FaLeaf /></div>
